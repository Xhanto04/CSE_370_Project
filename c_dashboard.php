...
if ($row = $result->fetch_assoc()) {
    ...
    $total_paid = $row['total_paid'] ?? 0.00;
    $total_pending = $row['total_pending'] ?? 0.00;
}
...
<body>
    ...
    <div class="navbar">
        ...
        <ul>
            ...
            <li><a href="c_dashboard.php?profile=show">Profile</a></li> <!-- Profile link added -->
            <li><a href="cedit_info.php">Edit Information</a></li>
            <li><a href="add_event.php">Apply for Event</a></li>
    ...
    <div class="container">
        ...
        <a href="pay.php?user_id=<?php echo urlencode($user_id); ?>" class="pay-link">Pay Your Unpaid Events</a>
    </div>
